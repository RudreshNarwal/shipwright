<!-- Thanks for contributing to Provenship! Keep PRs surgical and focused (Karpathy rules apply here too). -->
...
- [ ] I did **not** hand-edit a vendored skill (anything under `skills/` except `skills/provenship/`).
...
- [ ] If I edited `skills/provenship/SKILL.md`, its `description:` frontmatter is still **triggers-only**
